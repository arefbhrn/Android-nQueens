...
import co.arsatech.nqueens.nQueensGA.Chromosome;
import co.arsatech.nqueens.nQueensGA.RefObject;
import co.arsatech.nqueens.nQueensGA.nQueensGa;

public class GA extends AppCompatActivity {

    nQueensGa geneticAlgo;
    ImageView[] queens;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RefObject<ArrayList<Chromosome>> tempRef_initPopulation = new RefObject<>(initPopulation);
                ...
                while (initPopulation.get(0).fitness != nQueensGa.MAX_FIT) {
                    geneticAlgo.DoMating(tempRef_initPopulation, generations, crossoverProbability, mutationProbability);
                    initPopulation = tempRef_initPopulation.value;
                }
    ...
    private ArrayList<Chromosome> getInitialPopulation(int population) {
        ...
        nQueensGa RandomGen = new nQueensGa();
