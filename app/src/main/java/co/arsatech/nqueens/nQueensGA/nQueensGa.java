...
public class nQueensGa {
	...
	public final void DoMating(RefObject<ArrayList<Chromosome>> initPopulation,
							   int generations, double probCrossver, double probMutation) {
		int totalFitness = 0;
		RefObject<Integer> tempRef_totalFitness = new RefObject<>(totalFitness);
		...
		for (int generation = 0; generation < generations; generation++) {
			...
			RefObject<Integer> tempRef_totalFitness2 = new RefObject<>(totalFitness);
		...
		Collections.sort(initPopulation.value, new FitnessComparator());
	}

	public final void Crossover(RefObject<ArrayList<Chromosome>> parents, double probability) {
	...
	private void PrepareRuletteWheel(RefObject<ArrayList<Chromosome>> parents, int total) {
	...
	public final void Mutate(RefObject<ArrayList<Chromosome>> parents, double probability) {
	...
	public final void CalcFitness(RefObject<ArrayList<Chromosome>> chromosome, RefObject<Integer> totalFitness) {
		int collisions = 0;
